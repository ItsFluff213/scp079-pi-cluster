...
if [[ "$INSTALL_REMOTE" == "1" ]]; then
  install_remote_node "$DSAM_HOST" "pi5-dsam" "scripts/install_pi5_dsam.sh" ""
  install_remote_node "$LOGIC_HOST" "pi4-logic" "scripts/install_pi4_logic.sh" "scp079-voice-core.service"
fi
